...
# #########################################################
# # Label propagation regression 0 - CANCELADO
# #########################################################
# #
# # Primeira versão do Label Propagation Regression
# #
# # Imputação inicial por MEDIANA
# #
# # Sem divisão de classes
# #
# #########################################################

# class LabelPropagationRegression0():
...
#         #self.dataref = self.dataref.to_numpy()

#         # imputando através de média
#         imputer = SimpleImputer(missing_values=np.nan, strategy='median')
#         mean = imputer.fit(self.dataMiss)
#         self.dataImp = mean.transform(self.dataMiss)

#         # chama Label Propagation
#         retorno_lp = label_propagation(self.dataMiss, self.dataImp, self.epsilon, self.max_iter)
...
# #########################################################
# # Label propagation regression 1 - CANCELADO
# #########################################################
# #
# # Primeira versão do Label Propagation Regression
# #
...
# class LabelPropagationRegression1():
#     ''' Recebe dataframe de dados com o missing
#         Retorna dados completos
#     '''
#     # -------------------------------------------------------------------------------
...
# #########################################################
# # Label propagation regression 2 - CANCELADO
# #########################################################
# #
# # Primeira versão do Label Propagation Regression
# #
# # Imputação inicial por MICE
# #
# # Sem divisão de classes
# #
# #########################################################
...
#         # imputando através do MICE
#         imputer = IterativeImputer(max_iter=100)
#         mice = imputer.fit(self.dataMiss)
#         self.dataImp = mice.transform(self.dataMiss)
...
# #########################################################
# # Label propagation regression 3 - CANCELADO
# #########################################################
# #
# # Primeira versão do Label Propagation Regression
# #
...
# #########################################################
# # Label propagation regression 4 - CANCELADO
# #########################################################
# #
# # Primeira versão do Label Propagation Regression
# #
...
# class LabelPropagationRegression4():
#     ''' Recebe dataframe de dados com o missing
#         Retorna dados completos
#     '''
#     # -------------------------------------------------------------------------------
...
#             # imputando através do MICE
#             imputer = IterativeImputer(max_iter=100)
#             mice = imputer.fit(X_sem_imputar)
#             self.dataImp = mice.transform(X_sem_imputar)
...
#########################################################
# Label propagation regression 5 - Era o 5 e agora é o 0
#########################################################
#
# Label Propagation Regression
#
# Imputação inicial por média da classe
#
# COM divisão de classes
#    
...
class LabelPropagationRegression0():
    ...
    def fit(self, datamissing, train_target):       
        ...
        for i in groups:
            ...
            print("Antes do erro: ")
            print(type(df_imputed_classe))
            print(df_imputed_classe.shape)
            print("df.isnull().sum(): ")
            print(df_imputed_classe.isnull().sum())
            print("df.value_counts(): ")
            #print(df_imputed_classe.value_counts())

            cols_df = df_imputed_classe.columns

            for colunas in cols_df:
                print(colunas, ": ", df_imputed_classe[colunas].value_counts())

            print("________________________________________________")
            print(df_imputed_classe.dtypes)
            print(df_imputed_classe)
            colunas_teste = df_imputed_classe.columns
            ...
            print("Encontrando o danado do erro:")
            print("Shape dataImp_classe:", dataImp_classe.shape)
            print(type(dataImp_classe.shape))
            print(dataImp_classe)
            
            
            dataImp_teste = pd.DataFrame(dataImp_classe, columns=colunas_teste)
            print("Tentando novamente:")
            print("Shape dataImp_classe:", dataImp_teste.shape)
            print(type(dataImp_teste.shape))
            print(dataImp_teste)



            print("Shape parcial      :", self.dataImp.loc[self.dataImp['grupo'] == i].shape)
            print(type(self.dataImp.loc[self.dataImp['grupo'] == i]))
            print(self.dataImp.loc[self.dataImp['grupo'] == i])
...
# #########################################################
# # Label propagation regression 6 - CANCELADO
# #########################################################
# #
# # Label Propagation Regression
# #
...
# # COM divisão de classes
# #    
# # Imputação secundária por MICE (Transform)
# #
# #########################################################

# class LabelPropagationRegression6():
#     ''' Recebe dataframe de dados com o missing
#         Retorna dados completos
#     '''
#     # -------------------------------------------------------------------------------
...
#########################################################
# Label propagation regression 7 - Era o 7 e agora é o 1 (LPR1)
#########################################################
#
# Label Propagation Regression
#
...
#
# Não reliza o filtro no PREDICT
#
#########################################################
...
class LabelPropagationRegression1():
    ...
    def fit(self, datamissing, train_target):       
        ...
        for i in groups:
            ...
            print("Tipos de dado: ", type(df_imputed_classe))
            print(df_imputed_classe)
...
#########################################################
# Label propagation regression 8 - Era o 8 e agora é o 2 (LPR2)
#########################################################
#
# Label Propagation Regression
#
...
####################################################################################################
# Label propagation regression 3 (LPR3) - é uma cópia do 0, porém como inicialização igual a zero.
####################################################################################################
#
# Label Propagation Regression
#
...
#########################################################
# Label propagation regression (simples)
#########################################################

class LabelPropagationRegression():
    ''' Recebe dataframe de dados com o missing
        Retorna dados completos
    '''
    # -------------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------------    
    def transform(self, datamissing):
        ...
        # transform data
        scaled = scaler.fit_transform(self.dataImp)
     
        # fazendo o agrupamento por fast greedy
        #clustering = AgglomerativeClustering()
        #agrupamento = clustering.fit_predict(scaled)
        agrupamento = "em construção"
